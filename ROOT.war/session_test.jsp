...
server bind Address : <%=System.getProperty("jboss.bind.address")%><br>
server Name         : <%=System.getProperty("jboss.server.name")%><br>
<br>

server Home         : <%=System.getProperty("jboss.server.home.url")%><br>
server cluster name : <%=System.getProperty("jboss.partition.name")%><br>
server udp group    : <%=System.getProperty("jboss.partition.udpGroup")%><br>

<p>

referer : <%=request.getHeader("REFERER")%> <br>

serverInfo : <%=request.getSession().getServletContext().getServerInfo() %><br>
